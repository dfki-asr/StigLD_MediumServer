...
public class Controller {
    ...
    public String evolve = "prefix ex: <http://example.org/>\n"
	    ...
	    + "  ?stigma a st:Stigma , ex:UrgencyStigma ; st:concentration ?value .\n"
	    + "}\n"
	    + "WHERE {\n"
	    + "  ?package st:carries ?urgency .\n"
	    + "  ?stigma a st:Stigma , ex:UrgencyStigma ; st:concentration ?value .\n"
	    ...
	    + "INSERT {\n"
	    + "  ?package st:carries ?urgency .\n"
	    + "  ?urgency a st:Stigma , ex:UrgencyStigma ; st:concentration ?value .\n"
	    + "} WHERE {\n"
	    ...
	    + "\n"
	    + "  {?package a ex:Package ; ex:located ?location .} UNION { ?package a ex:Package ; ex:located ?area . ?truck a ex:Truck ; ex:areas ?area ; ex:located ?location .}\n"
	    + "  ?goal a ex:Goal ; ex:payload ?package ; ex:deadline ?deadline ; ex:destination [ ex:driveTime [ ex:destination ?location ; rdf:value ?driveTime  ]] .\n"
	    + "\n"
	    + "  BIND((?deadline - ?timePassed) as ?remaining)\n"
	    + "  BIND((?driveTime * ?confidence) as ?confidentRequired)\n"
	    + "\n"
