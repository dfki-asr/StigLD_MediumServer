...
public class xmlParse {
    public static void main(String[] args) {
        ...
        try {
            QueryExecution qexec_openOrd = QueryExecutionFactory.createServiceRequest("http://fusekiserver:3230/ds/", openOrd_query);
            QueryExecution qexec_transpPos = QueryExecutionFactory.createServiceRequest("http://fusekiserver:3230/ds/", transporterPos_query);
            QueryExecution qexec_workTask = QueryExecutionFactory.createServiceRequest("http://fusekiserver:3230/ds/", workTask_query);
            QueryExecution qexec_countArtif = QueryExecutionFactory.createServiceRequest("http://fusekiserver:3230/ds/", countArtif_query);
